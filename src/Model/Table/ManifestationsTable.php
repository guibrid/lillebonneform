 ...
 * @method \App\Model\Entity\Manifestation newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Manifestation[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Manifestation|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Manifestation patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Manifestation[] patchEntities($entities, array $data, array $options = [])
