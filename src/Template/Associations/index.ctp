...
<?php } ?>
        ...
        <table>
        <tr><td>Moins de 15 ans (2002 et après) :</td><td> <?= h($association->licence_moins15) ?></td></tr>
        <tr><td>Moins de 15 ans pratiquant la compétition :</td><td> <?= h($association->licence_moins15Compet) ?></td></tr>
        <tr><td>Plus de 15 ans (2001 et avant) :</td><td> <?= h($association->licence_plus15) ?></td></tr>
        ...
        <h4><?= __('Finances') ?></h4>
        <table><tr><td>Compte de résultat de la saison écoulée 2017 :</td><td> <?= h($association->compte_resultat_doc) ?></td></tr>
        <tr><td>Grand livre 2017  :</td><td> <?= h($association->grand_livre_doc) ?></td></tr>
        <tr><td>Budget réalisé saison sportive 2017-2018  :</td><td> <?= h($association->budget_realise_doc) ?></td></tr>
        <tr><td>Budget prévisionnel saison sportive 2018-2019  :</td><td> <?= h($association->budget_previsionnel_doc) ?></td></tr>
      </table>
    <?php endforeach; ?>
