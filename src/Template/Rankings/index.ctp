...
/**
  ...
  * @var \App\Model\Entity\Ranking[]|\Cake\Collection\CollectionInterface $rankings
  */
?>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('association_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($ranking->modified) ?></td>
                <td><?= $ranking->has('association') ? $this->Html->link($ranking->association->name, ['controller' => 'Associations', 'action' => 'view', $ranking->association->id]) : '' ?></td>
                <td class="actions">
